...
import { Share2, Save, ArrowRight, LogOut, Plus, Trash2 } from 'lucide-react';
...
export default function CadastroRedesSociais() {
  ...
  useEffect(() => {
    api.get(`/social-networks/company/${id}`)
      .then(res => {
        if (res.data) {
  ...
  function updateOutraRede(index: number, field: keyof OutraRede, value: string) {
          ...
          <div className="bg-white rounded-2xl shadow-xl p-10">
            ...
            <div className="flex justify-between items-start mb-6 gap-4 flex-wrap">
              <div>
                ...
                <p className="text-sm text-gray-500 mt-1">Etapa 4 de 8 - Redes Sociais</p>
              </div>
            ...
            <div className="flex items-center gap-3 mb-2">
              ...
              <h2 className="text-2xl font-semibold text-gray-800">Redes Sociais</h2>
            </div>
            <p className="text-gray-500 mb-8">Informe os perfis da sua empresa nas redes sociais.</p>
                  ...
                  {outras.map((rede, index) => (
                    <div key={index} className="border border-gray-200 rounded-xl p-5">
                      <div className="flex justify-between items-center mb-4">
                        <span className="text-sm font-medium text-gray-600">Rede {index + 1}</span>
                        <button
                          type="button"
                      ...
                      <div className="grid md:grid-cols-2 gap-4">
                        <div>
                          ...
                          <input
                            type="text"
                            value={rede.nome}
                            onChange={(e) => updateOutraRede(index, 'nome', e.target.value)}
                        ...
                        <div>
                          ...
                          <input
                            type="url"
                            value={rede.url}
                            onChange={(e) => updateOutraRede(index, 'url', e.target.value)}
                            placeholder="https://..."
                            className={inputStyle}
                          />
                        </div>
