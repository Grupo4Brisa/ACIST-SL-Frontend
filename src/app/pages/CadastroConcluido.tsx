...
const PROXIMOS_PASSOS = [
  {
    icon: ClipboardList,
    texto: "Seu cadastro será analisado pela equipe ACIST",
  },
  { icon: Mail, texto: "Você receberá um e-mail com o resultado da análise" },
  {
    icon: Star,
    texto: "Caso aprovado, você terá acesso aos benefícios da ACIST",
  },
];
          ...
          <div className="bg-white rounded-2xl shadow-xl p-10">
            ...
            <div className="flex flex-col items-center text-center mb-10">
              ...
              <p className="text-gray-500 text-base max-w-xl">
                Seu cadastro foi enviado com sucesso e está em análise pela
                equipe ACIST. Você receberá um e-mail com o resultado da
                aprovação em breve.
              </p>
            </div>
            ...
            <div className="flex items-start gap-3 p-4 bg-amber-50 border border-amber-200 rounded-xl mb-10">
              ...
              <p className="text-sm text-amber-700">
                <strong>Importante:</strong> Este link não pode mais ser
                utilizado. Seu cadastro já foi registrado em nosso sistema.
              </p>
            </div>
