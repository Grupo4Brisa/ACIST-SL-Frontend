...
const PROXIMOS_PASSOS = [
  ...
  },
  {
    icon: Mail,
    texto:
      "Após a confirmação do pagamento você receberá um e-mail contendo um link exclusivo para concluir seu cadastro",
  },
  {
    icon: Clock,
    texto:
      "Após receber o e-mail, acesse o link e complete as informações da sua empresa",
  },
];
          ...
          <div className="bg-white rounded-2xl shadow-xl p-10">
            ...
            <div className="flex flex-col items-center text-center mb-10">
              ...
              <p className="text-gray-500 text-base max-w-xl">
                Seu pagamento foi registrado e está aguardando confirmação pela
                equipe da ACIST.
              </p>
            ...
            <div className="flex items-start gap-3 p-4 bg-amber-50 border border-amber-200 rounded-xl mb-10">
              ...
              <p className="text-sm text-amber-700">
                ...
                você receberá um e-mail com um link exclusivo para completar seu
                cadastro. Guarde o e-mail informado no cadastro.
              </p>
            </div>
