...
export default function BoasVindas() {
  ...
  // ID real da empresa/cadastro criado no backend
  const empresaId =
              ...
              <div className="p-8 md:p-12 flex flex-col justify-center">
                ...
                <div className="mb-8">
                  ...
                  <p className="text-lg text-gray-700 mb-6">
                    ...
                    Sua associação à ACIST São Leopoldo foi iniciada com sucesso!
                  ...
                  <div className="space-y-4 mb-8">
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <p className="text-gray-700">
                        ...
                        Você poderá acessar sua área do associado.
                  ...
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
                    ...
                    <ul className="space-y-2 text-sm text-gray-700">
                      ...
                      <li>
                        ...
                        ✓ Sua associação será validada pela equipe ACIST
                      ...
                      <li>
                        ...
                        ✓ Terá acesso aos benefícios da associação
                      ...
                      <li>
                        ...
                        ✓ Poderá participar de eventos e capacitações
