...
export default function CadastroTermos() {
  ...
  async function handleFinalizar() {
    if (!aceito) {
      setError(
        "Você precisa aceitar o Termo de Adesão para finalizar o cadastro.",
      );
      return;
    }
    try {
        ...
        <div className="max-w-5xl mx-auto px-6 py-12 w-full">
          <div className="bg-white rounded-2xl shadow-xl p-10">
            ...
            <div className="border border-gray-200 rounded-xl p-8 bg-gray-50 max-h-[480px] overflow-y-auto text-sm text-gray-700 leading-relaxed space-y-5 mb-8">
              ...
              <p>
                Pelo presente instrumento, a empresa acima qualificada manifesta
                seu interesse em associar-se à
                <strong>
                  {" "}
                  ASSOCIAÇÃO COMERCIAL, INDUSTRIAL, DE SERVIÇOS E TECNOLOGIA DE
                  SÃO LEOPOLDO - ACIST
                </strong>
                , declarando conhecer e concordar com os termos do Estatuto
                Social e Regimento Interno da entidade.
              </p>

              <div>
                <p className="font-semibold text-gray-800 mb-2">
                  1. CONDIÇÕES DE ASSOCIAÇÃO
                </p>
                <p>
                  A empresa associada compromete-se a pagar pontualmente a
                  mensalidade estabelecida conforme o porte da empresa, bem como
                  taxas de eventos e serviços adicionais que venha a utilizar.
                </p>
              </div>
              ...
              <div>
                ...
                <p>
                  A ACIST compromete-se a tratar os dados pessoais e
                  empresariais fornecidos em conformidade com a Lei Geral de
                  Proteção de Dados (LGPD - Lei nº 13.709/2018), utilizando-os
                  exclusivamente para os fins relacionados aos serviços
              ...
              <div>
                ...
                <p>
                  O associado poderá solicitar o cancelamento de sua associação
                  a qualquer momento, mediante comunicação por escrito, ficando
                  responsável pelo pagamento das mensalidades vencidas até a
                  data da solicitação.
                </p>
              </div>

              <p className="italic text-gray-500">
                Ao aceitar este termo, declaro ter lido, compreendido e
                concordado com todas as condições estabelecidas acima.
              </p>
            </div>
            ...
            >
              ...
              <span className="text-sm text-gray-700 leading-relaxed">
                Li e concordo com o Termo de Adesão e declaro que todas as
                informações fornecidas são verdadeiras e estou ciente das
                condições de associação à ACIST São Leopoldo.
              </span>
            </label>
