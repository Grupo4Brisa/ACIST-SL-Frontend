...
export default function CadastroQualificacao() {
  ...
  function handleNext() {
    console.log("Dados qualificação:", formData);
      ...
      <main className="flex-1">
        <div className="max-w-3xl mx-auto px-6 py-12">
          <div
            ...
            "
          >
            <h2 className="mb-2">Qualificação da Empresa</h2>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    handleChange("faturamentoAnual", e.target.value)
                  }
                >
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    handleChange("quantidadeFuncionarios", e.target.value)
                  }
                >
                  <option value="">Selecione</option>
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    handleChange("interessePrincipal", e.target.value)
                  }
                >
                  <option value="">Selecione</option>
                  ...
                  <option value="servicos">Serviços e benefícios</option>
              ...
              <div>
                ...
                >
                  ...
                  <option value="evento">Evento da ACIST</option>
            ...
            <div
              ...
              "
            >
              <h3 className="mb-3">Por que precisamos dessas informações?</h3>
              ...
              <p
                ...
                "
              >
                A ACIST utiliza essas informações para direcionar benefícios,
                eventos, capacitações e oportunidades de acordo com o perfil da
                empresa.
              </p>
            </div>
            {/* NAVEGAÇÃO */}
            ...
            >
              <button
                type="button"
                onClick={() => navigate("/cadastro/contatos")}
                className="
                  px-6
                  py-3
                  border
