...
function normalizarPorte(porte: string) {
  return porte.toUpperCase().normalize("NFD").replace(/[̀-ͯ]/g, "");
}
...
export default function CadastroMensalidade() {
  ...
  useEffect(() => {
    async function carregarPorte() {
      ...
      const localPorte =
        companyData?.companySize || localStorage.getItem("companySize") || "";
        ...
        <div className="max-w-5xl mx-auto px-6 py-12 w-full">
          <div className="bg-white rounded-2xl shadow-xl p-10">
            ...
            <p className="mt-4 text-xs text-gray-400 text-center">
              O valor é calculado automaticamente com base no porte da empresa e
