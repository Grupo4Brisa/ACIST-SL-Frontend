    ...
    <div className="p-4 sm:p-8">
      ...
      <div className="mb-6">
        ...
        <p className="text-gray-500 mt-1">
          Gestão de todos os cadastros de leads e associados
        </p>
      </div>
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-4 mb-6 flex flex-col md:flex-row gap-3">
        ...
        <div className="relative">
          ...
          <select
            ...
            className="w-full md:w-auto pl-9 pr-8 py-2.5 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#0C3A59] bg-white"
          >
      ...
      <p className="text-sm text-gray-500 mb-4">
        {filtradas.length} empresa{filtradas.length !== 1 ? "s" : ""} encontrada
                ...
                >
                  ...
                  <td className="px-5 py-4">
                    <div className="flex flex-col gap-1">
                      <span
                        className={`px-2.5 py-1 rounded-full text-xs font-medium ${STATUS_CADASTRO[company.status]?.color || "bg-gray-100 text-gray-600"}`}
                      >
                        {STATUS_CADASTRO[company.status]?.label ||
                          company.status}
                      </span>
                      <span
                        className={`px-2.5 py-1 rounded-full text-xs font-medium ${STATUS_APROVACAO[company.status]?.color || "bg-gray-100 text-gray-600"}`}
                      >
