      ...
      <div className="flex-1 max-w-5xl mx-auto px-6 py-8 w-full">
        ...
        <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-[#0C3A59] to-[#226897] p-8 text-white">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <span>{evento.inscritos} inscritos de {evento.vagas} vagas</span>
              </div>
            </div>
          </div>
          ...
          <div className="p-8">
            ...
            {/* Local */}
            <div className="mb-8">
              <h2 className="text-2xl font-semibold text-[#0C3A59] mb-4">Local</h2>
            ...
            {evento.palestrante && (
              <div className="mb-8">
                <h2 className="text-2xl font-semibold text-[#0C3A59] mb-4">Palestrante</h2>
            ...
            {/* Programação */}
            <div className="mb-8">
              <h2 className="text-2xl font-semibold text-[#0C3A59] mb-4">Programação</h2>
            ...
            {/* Vagas */}
            <div className="mb-8">
              <h2 className="text-2xl font-semibold text-[#0C3A59] mb-4">Disponibilidade</h2>
            ...
            <div className="border-t border-gray-200 pt-6">
              {!presencaConfirmada ? (
                ...
                >
                  {vagasDisponiveis > 0 ? 'Confirmar Presença' : 'Lista de Espera'}
                </button>
              ) : (
